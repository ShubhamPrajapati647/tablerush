  ...
  head: () => ({
    meta: [
      ...
      { title: "Table Rush — Turn Every Table Into an Experience" },
      {
        name: "description",
        content:
          "Table Rush connects guests with restaurants and cafés: discover venues, scan your table, order, pay and play.",
      },
      { property: "og:title", content: "Table Rush — Turn Every Table Into an Experience" },
      {
        property: "og:description",
        content: "Discover. Order. Play. Enjoy. QR ordering and table experiences for venues.",
      },
